...
Fixed: Praetorians promotions not respecting Oppressor's soft limit.

Wave Power Increase: Waves 1 and 2 now scale in power over time, reaching their old strength at 10 minutes and doubling in power after 20 minutes. may differ per mission type, length and complexity 

Difficulty Adjustments: Reduced enemy difficulty rating on PE from 175 to 125.

Nitra Multiplier: Added for longer missions to balance increasing custom wave sizes (untested).

Custom Waves: Slowed power scaling for longer missions to account for extended duration (untested).

Downed Dwarf Safety Net: Increased to 2 minutes per downed dwarf in various waves.

Naedocyte Stabber: Increased burst interval from 10s to 30s, reduced burst size from 2 eggs to 1, and decreased egg health from 60 to 20.

Turbo Nexus: Decreased max spawn count for Turbomenace from 30 to 20 (4 players).

Resistance Changes:

    Fire Grunts (red): Fire resistance reduced from 65% to 35%.
    Frost Grunts (cyan): Frost resistance reduced from 65% to 35%.
    Both changes made to balance weapon effectiveness (untested).
...
Base Hazard Settings:
    ...
    Swarm Timers: 15 seconds longer (or 35 seconds longer for Refinery missions).
...
Vanilla Enemies:
    ...
    Swarmers: HP reduced to 5, 40% smaller, fear and stun immune, don’t die when frozen.
