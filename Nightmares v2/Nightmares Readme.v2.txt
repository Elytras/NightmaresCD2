...
Last change:
Exploder bomber MaxSpawnCount set to 2

Nukepoter MaxSpawnCount set to 1
Nukopters are in disruptive pool (forgot to add in the txt file initially)

Red oppressors MaxSpawnCount 1 and Rarity 8
Removed from constant pressure
Added to encounters
White oppressor MaxSpawnCount 1 and Rarity 7
Removed from constant pressure
Added to encounters
Cyan oppressors MaxSpawnCount 2 and Rarity 7
Added to constant pressure
Removed from encounters
Yellow oppressor
Removed from constant pressure and encounters
VeteranLarge 0.15
Arbabomber Rarity decreased to 7.5
Praetorian variants moved to common pool
Exploder Bombers MaxSpawnCount decreased from 2 to 1
Nexus stingtails TimeDilation 2.5 -> 2
Added recolored grunt veteran variants into normal pool
Mini swarmers rarity 2 -> 1
Greg's rarity 9 (attempt to spawn)
Gregomber Rarity 16 -> 13 (attemp to spawn)
All Nexii were named accordnigly to enemies they spawn
Yellow breeders now spawn shredders
Web Spitter variant rarity 7 -> 4 (attempt to spawn more)
