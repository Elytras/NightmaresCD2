...
Last change:
Speedbumps and Roadblocks now immortal lootbugs
Removed 75% courage, 1.5x stun duration multiplier and 10x stun immunity for arbabomber
Acid bomber added as a veteran of goo bomber
Added UnlockInterval to waves 1, 2 and 5
Minibulks from Bulkonator are now alert
Naedocyte Bombers now get damaged overtime if 3 or more alive at once
Nexus Stingtails TimeDilation from 2x to 1x; MaxSpeed x2, MaxAcceleration x2, MaxBrakingDeceleration x2
Decreased wave size for wave 1 and 2, made them scale with player count
Bots burn temperature decreased from 250 to 125
